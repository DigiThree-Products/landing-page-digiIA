  ...
  return (
    <header className="hero" id="cadastro">
      <div className="hero-in stagger">
        ...
        <p className="sub">
          A Digi.IA escreve posts, monta calendário editorial e gera campanhas inteiras já falando
          com a voz da sua marca. Entre na lista antes do lançamento e{' '}
